...
# Re-use the coloured log helpers from the main module.  Import them
# lazily so the scheduler module stays self-contained if the helpers
# are not available (e.g. in unit tests).
try:
    from core.MicroPDProxyServer import (
        log_info_blue,
        log_info_red,
        log_info_yellow,
